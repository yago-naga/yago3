...
//				TemporalCategoryExtractor.TEMPORALCATEGORYFACTS,
	...
	public static final Theme YAGOMETAFACTS = new Theme(
			"yagoMetaFacts",
	...
	public static final Set<String> relationsExcluded = new FinalSet<>(
			YAGO.extractionSource, YAGO.extractionTechnique);

	public static void main(String[] args) throws Exception {
		Announce.setLevel(Announce.Level.DEBUG);
		new MetaFactExtractor().extract(new File("C:/fabian/data/yago2s"),
				"test");
	}
