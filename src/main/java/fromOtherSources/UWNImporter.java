...
public class UWNImporter extends DataExtractor {
	...
	public void extract() throws Exception {
		...
		Map<String, String> wnssm = WordnetExtractor.WORDNETIDS
				.factCollection().getReverseMap("<hasSynsetId>");
		Map<String, String> tlc2language = HardExtractor.HARDWIREDFACTS
				.factCollection().getReverseMap("<hasThreeLetterLanguageCode>");

		for (String line : new FileLines(inputData, "UTF-8",
				"Importing UWN mappings")) {
