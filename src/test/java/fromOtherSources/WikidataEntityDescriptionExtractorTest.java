...
public class WikidataEntityDescriptionExtractorTest {
  ...
  public void extractorTest() throws Exception {
     ...
     // Output of the extract function (wikidataEntityDescription.tsv) is written in the second second argument.
  ...
  public void compareOutputWithExpected() throws IOException{
    String actual   = new String(Files.readAllBytes(Paths.get(RESOURCESPATH + "/output/wikidataEntityDescription.tsv")));
    String expected = new String(Files.readAllBytes(Paths.get(RESOURCESPATH + "/output/expected_wikidataEntityDescription.tsv")));
