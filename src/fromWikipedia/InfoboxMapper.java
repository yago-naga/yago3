...
public class InfoboxMapper extends Extractor {
	...
	public Set<Extractor> followUp() {
		return new HashSet<Extractor>(Arrays.asList(new Redirector(
				INFOBOXFACTS_TOREDIRECT, INFOBOXFACTS_TOTYPECHECK, this),
				new TypeChecker(INFOBOXFACTS_TOTYPECHECK, INFOBOXFACTS, this)));
	}
	...
	public Set<Theme> output() {
		return new HashSet<>(Arrays.asList(INFOBOXFACTS_TOREDIRECT,
				INFOBOXSOURCES));
	...
	protected void extract(String entity, String string, String relation,
		...
		for (String object : objects) {
			...
			if (inverse) {
				...
				write(writers, INFOBOXFACTS_TOREDIRECT, fact, INFOBOXSOURCES,
...
//		 "Test on 1 wikipedia article");
		Extractor extractor = Extractor.forName("fromWikipedia.InfoboxMapper", null);
