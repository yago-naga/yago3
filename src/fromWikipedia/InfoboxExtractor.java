...
public class InfoboxExtractor extends Extractor {
  ...
  static {
    for (String s : Extractor.languages) {
      ...
      INFOBOXATTSOURCES_MAP.put(s, new Theme("yagoInfoboxAttSources" + Extractor.langPostfixes.get(s), "Sources for facts of infobox",
          ThemeGroup.OTHER));
      INFOBOXTYPES_MAP.put(s, new Theme("infoboxTypes" + Extractor.langPostfixes.get(s), "Types of infoboxes", ThemeGroup.OTHER));
      INFOBOXTYPESTRANSLATED_MAP.put(s, new Theme("infoboxTypesTranslated" + Extractor.langPostfixes.get(s), "Types of infoboxes", ThemeGroup.OTHER));
      INFOBOXTYPESBOTHTRANSLATED_MAP.put(s, new Theme("infoboxTypesBothTranslated" + Extractor.langPostfixes.get(s), "Types of infoboxes",
          ThemeGroup.OTHER));
    }
  ...
  public Set<Extractor> followUp() {
    return new HashSet<Extractor>(Arrays.asList(new Translator(INFOBOXTYPES_MAP.get(this.language),
        INFOBOXTYPESBOTHTRANSLATED_MAP.get(this.language), this.language, "Infobox"), new InfoboxTypeExtractor(this.language),
        new InfoboxTermExtractor(this.language), new AttributeMatcher(this.language), new InfoboxMapper(this.language)));
  ...
  protected void extract(String entity, String string, String relation, String attribute, Map<String, String> preferredMeanings,
    ...
    for (String object : objects) {
      ...
      if (inverse) {
        ...
        write(writers, INFOBOXATTS_MAP.get(language), fact, INFOBOXATTSOURCES_MAP.get(language), FactComponent.wikipediaURL(entity),
      ...
      switch (FileLines.findIgnoreCase(in, "<title>", "{{Infobox", "{{ Infobox", "<comment>")) {
        ...
        case 0:
          ...
          if (this.language.equals("en")) {
            ...
            titleEntity = titleExtractor.getTitleEntityWithoutWordnet(in);
          }
          break;
        case 3:
        ...
        default:
          ...
          for (String attribute : attributes.keySet()) {
            for (String value : attributes.get(attribute)) {
              write(writers, INFOBOXATTS_MAP.get(language), new Fact(titleEntity, addPrefix(this.language, FactComponent.forYagoEntity(attribute)),
                  FactComponent.forString(value)), INFOBOXATTSOURCES_MAP.get(language), FactComponent.wikipediaURL(titleEntity), "Infobox Extractor");
            }
          }
  ...
  public static void main(String[] args) throws Exception {
    new InfoboxExtractor(new File("/home/jbiega/Downloads/en_pol.xml")).extract(new File("/home/jbiega/data/yago2s/"), "Test on 1 wikipedia article");
