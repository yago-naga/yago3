...
# /local/java/jdk1.7.0/bin/javac -cp "basics2s/bin:javatools/bin"  -d "converters2s/bin" @sources_list.txt
 /local/java/jdk1.7.0/bin/javac -cp "basics2s/bin:javatools/bin"  -d "converters2s/bin" converters2s/src/converters/TsvConverter.java
